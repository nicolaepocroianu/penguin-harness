...
export const en: Strings = {
  ...
  activities: {
    ...
    workspaceSections: "Activity sections",
  ...
  codingAgents: {
    runsTitle: "Coding agent runs",
    runsDescription:
      "Runs coding agents make for activity stages. Chats with a coding agent are in the sidebar like any other Session.",
    runsManageLink: "Manage coding agents in Models",
    agentsTitle: "Agents",
    addAgent: "Add agent",
